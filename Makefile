...
ACLOCAL = ${SHELL} /media/tom/BabyishFS/Divelopmènt/hunspell/missing --run aclocal-1.11
ALLOCA = 
AMTAR = $${TAR-tar}
AR = ar
AS = as
AUTOCONF = ${SHELL} /media/tom/BabyishFS/Divelopmènt/hunspell/missing --run autoconf
AUTOHEADER = ${SHELL} /media/tom/BabyishFS/Divelopmènt/hunspell/missing --run autoheader
AUTOMAKE = ${SHELL} /media/tom/BabyishFS/Divelopmènt/hunspell/missing --run automake-1.11
AWK = mawk
...
LTLIBPTH = 
LTLIBTHREAD = 
MAKEINFO = ${SHELL} /media/tom/BabyishFS/Divelopmènt/hunspell/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
...
abs_builddir = /media/tom/BabyishFS/Divelopmènt/hunspell
abs_srcdir = /media/tom/BabyishFS/Divelopmènt/hunspell
abs_top_builddir = /media/tom/BabyishFS/Divelopmènt/hunspell
abs_top_srcdir = /media/tom/BabyishFS/Divelopmènt/hunspell
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /media/tom/BabyishFS/Divelopmènt/hunspell/install-sh
